...
<head>
<?php $title = " Devzila RoR Application Development" ?>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
      <div class="row">
        ...
        <h1>Ruby On Rails Consulting</h1>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3>Do you have a web application on Ruby on Rails? or do you want to get new Ruby on Rails application done? Well you have landed at the right place!</h3>
        </div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3> Our Experienced Ruby on Rails Consulting Team Can Help You</h3>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              <div class="icon"></div>
              <p>Find the right solutions to promote and accelerate your business by designing dynamic, secure and profitable websites and mobile apps solutions for your business.Read More about custom development using Ruby on Rails</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              <div class="icon"></div>
              <p>Identify the issues with your existing Ruby on Rails web solutions to make your existing RoR application robust, bug-free and scalable.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Expand your existing Ruby on Rails Web solutions by implementing new features, modules all the while ensuring that the applications are stable and fast.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              Upgrade your existing Ruby on Rails Web applications to the latest cutting-edge versions of Ruby on Rails for better performance. Read More about the latest upgrades.</p>
            </div>
          </div>
